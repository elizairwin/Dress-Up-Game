$(document).ready(function () {
    ...
    $("#shirt_button").on("click", function () { shirt_picker.Next(); });

    var pants_picker = new imageCycler(pants);
    $("#pant_button").on("click", function () { pants_picker.Next(); });

    var bg_picker = new imageCycler(backgrounds);
    $("#bg_button").on("click", function () { bg_picker.Next(); });
